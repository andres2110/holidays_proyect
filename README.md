...
So I opted to create a new array of objects that would have the necessary information to do this ( {country: 'EC', holidays: [] } ), becouse later for to creates a Components, i just use a map to create and not have more logic to manipulate.

I tried to use groupBy but I couldn't make it work, so I sorted it by the default countries and create my own object.
